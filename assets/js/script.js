console.log("%cHello🙌", "font-size: 20px; color:green");

console.log(
    "%c👉 This Website is build with html, css(sass), javascript and a lots of love",
    "font-size: 15px; color:green"
);

console.log("%c👉 This is the last project in the f8 course html css pro😎", "font-size: 15px; color:green");
